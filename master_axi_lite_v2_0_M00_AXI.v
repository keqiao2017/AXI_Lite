...
`timescale 1 ns / 1 ps
    ...
    // and read transactions the master will perform as a part of this example memory test.
		parameter integer C_M_TRANSACTIONS_NUM	= 25//4
	)
	(
	  ...
	  always @(posedge M_AXI_ACLK)                                  
	      begin                                                     
	        ...
	        // available by user logic                              
	          ...
	          begin                                                 
	            axi_wdata <= C_M_START_DATA_VALUE + memory[write_index];    
	          end                                                   
	        end          	                                       
	  ...
	  always @(posedge M_AXI_ACLK)                                  
	      begin                                                     
	        if (M_AXI_ARESETN == 0  || init_txn_pulse == 1'b1)                                
	          ...
	          begin                                                 
	            expected_rdata <= C_M_START_DATA_VALUE + memory[read_index];
	          end                                                   
	      end                                                       
	...
	integer i;
	  always @(posedge M_AXI_ACLK ) 
	   begin
		if (M_AXI_ARESETN == 0)// if (M_AXI_ARESETN == 0  || init_txn_pulse == 1'b1) 
		addr <= 5'b0;
		else 
		begin
			if (addr < 5'd24) begin
